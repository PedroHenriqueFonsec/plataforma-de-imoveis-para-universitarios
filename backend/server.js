...
app.use(cors({
  origin: [
    "https://plataforma-de-imoveis-para-universi.vercel.app",
    "http://localhost:5173",
    "http://localhost:3000"
  ],
...
const mongoURI = process.env.MONGO_URI || "mongodb://localhost:27017/plataforma-de-imoveis-para-universitarios";
